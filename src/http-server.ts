...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across UODO decisions (sanctions, reprimands, and administrative decisions). Returns matching decisions with reference, entity name, fine amount, and GDPR articles cited.",
    inputSchema: {
  ...
  },
  {
    ...
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "UODO decision reference" },
      },
      required: ["reference"],
    },
  },
  {
    ...
    description:
      "Search UODO guidance documents: guidelines, opinions, recommendations, and circulars.",
    inputSchema: {
      type: "object" as const,
      properties: {
